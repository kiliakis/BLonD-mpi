...
n_turns = max(n_iterations, n_turns)
...
for turn in range(n_iterations):
    ...
    worker.trackDelay(turn)
    # if worker.isMaster:

    #     plot_long_phase_space(ring, rf, beam, 0, 0.0001763*h, -1e8, 1e8, xunit = 's',
    #                       sampling = 1, separatrix_plot = True, histograms_plot = True,
    #                       dirname = this_directory + '/../output_files/phasespace/',
    #                       alpha = 1, color = 'b')
