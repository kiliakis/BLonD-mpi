...
gconfig = {
    ...
    'outfiles': ['{}/{}-{}.png'],
    'files': [
        '{}/cluster/{}/approx0-interm/comm-comp-report.csv',
        '{}/cluster/{}/approx2-interm/comm-comp-report.csv',
        '{}/cluster/{}/approx1-interm/comm-comp-report.csv',
        '{}/cluster/{}/tp-approx0-interm/comm-comp-report.csv',
        '{}/cluster/{}/lb-tp-approx0-interm/comm-comp-report.csv',
        '{}/cluster/{}/lb-tp-approx2-interm/comm-comp-report.csv',
        '{}/cluster/{}/lb-tp-approx1-interm/comm-comp-report.csv',
    ],
    'lines': {
