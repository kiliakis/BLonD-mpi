...
class SlicesMonitor(object):
    ...
    def __init__(self, filename, n_turns, profile, rf, Nbunches, buffer_size=100):
        ...
        self.create_data(
            ...
            dtype='float64')
        self.create_data(
            'dE_norm', self.h5file['default'], (self.n_turns, self.Nbunches),
            dtype='float64')
        ...
        self.create_data(
            'dt_norm', self.h5file['default'], (self.n_turns, self.Nbunches),
            dtype='float64')
        ...
        self.create_data('bunch_position', self.h5file['default'],
        ...
        self.b_bunch_position = np.zeros(
            (self.buffer_size, self.Nbunches), dtype=float)
        self.b_bunch_length = np.zeros(
            (self.buffer_size, self.Nbunches), dtype=float)
